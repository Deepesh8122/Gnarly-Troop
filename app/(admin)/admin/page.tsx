...
export default async function AdminDashboardPage() {
  ...
  const cards = stats
    ? [
        ...
        { label: "Registrations", value: stats.registrations, href: "/admin/events/" },
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="mt-1 text-slate-600">
          Edit content in each module — changes appear on the public site within about a
          minute. Run the import below once if leadership/collaboration tables are empty.
        </p>
      </div>

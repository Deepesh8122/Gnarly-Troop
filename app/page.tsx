...
import SectionSummit from "@/components/sections/Summit/SectionSummit";
import SectionSummit1 from "@/components/sections/Summit/SummitSection1";
  ...
  return (
    <>
      ...
      <main>
        ...
        />
        <SectionTimeline />
        <SectionVisionsResponsive />
        <SectionVisions />
        <SectionMinistries />
        <SectionSummit1 />
        <SectionSchedules />
        <SectionSikkimTrain />
        <SectionSikkimPackage />
        <SectionSikkimCircles />
        <SectionPartners />
        <SectionGallery />
        <SectionFooter />
      </main>
